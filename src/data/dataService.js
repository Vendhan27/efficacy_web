...
// ===== SEED DATA =====
const SEED_EVENTS = [
  { id: 'ev1', name: 'Paper Presentation', category: 'Tech', description: 'Present your innovative ideas and research papers on emerging technologies in Mechanical Engineering. Showcase your knowledge and communication skills.', rules: '1. Team of 2 members\n2. Time limit: 8+2 minutes\n3. Abstract must be submitted prior\n4. PPT must be original work\n5. Topics related to Mechanical Engineering only', poster: '', coordinator: 'Arun Kumar S', phone: '9876543210', createdAt: '2026-01-15' },
  { id: 'ev2', name: '3D CAD Modeling (Design Challenge)', category: 'Tech', description: 'Put your CAD skills to the test! Design complex components and assemblies using industry-standard software. Speed, accuracy, and design intent will be judged.', rules: '1. Individual event\n2. Software: SolidWorks / Fusion 360 / AutoCAD\n3. Time limit: 60 minutes\n4. 2D drafting to 3D model conversion\n5. Bring your own laptop (optional but recommended)', poster: '', coordinator: 'Priya M', phone: '9876543211', createdAt: '2026-01-16' },
  { id: 'ev3', name: 'Mech Core Quiz', category: 'Tech', description: 'Challenge your core mechanical engineering knowledge in this fast-paced quiz covering thermodynamics, fluid mechanics, manufacturing, and general aptitude.', rules: '1. Team of 2 members\n2. Three rounds: Prelims, Semis, Finals\n3. No electronic devices\n4. Judges decision is final\n5. Negative marking in finals', poster: '', coordinator: 'Karthik R', phone: '9876543212', createdAt: '2026-01-17' },
  { id: 'ev4', name: 'Legend in Lathe (Machining)', category: 'Tech', description: 'Showcase your practical workshop skills. Participants will be given a raw workpiece and a drawing to machine the exact component using a conventional Lathe machine within the given time.', rules: '1. Individual event\n2. Proper workshop attire (shoes) is mandatory\n3. Time limit: 2 hours\n4. Machining accuracy and finish will be evaluated\n5. Safety protocols must be strictly followed', poster: '', coordinator: 'Deepika S', phone: '9876543213', createdAt: '2026-01-18' },
  { id: 'ev5', name: 'Connections', category: 'Non-Tech', description: 'A fun-filled visual puzzle game where you connect the dots between seemingly unrelated clues to arrive at a common answer. Test your lateral thinking!', rules: '1. Team of 2 members\n2. Multiple rounds\n3. Time-based scoring\n4. No electronic devices\n5. Judges decision is final', poster: '', coordinator: 'Vishnu K', phone: '9876543214', createdAt: '2026-01-19' },
  { id: 'ev6', name: 'Workshop on 3D Printing', category: 'Workshop', description: 'Hands-on workshop covering the fundamentals of additive manufacturing, 3D modeling for print, and practical experience with FDM 3D printers.', rules: '1. Individual participation\n2. Laptop required\n3. Software will be provided\n4. Certificate will be issued\n5. Limited seats available', poster: '', coordinator: 'Ramesh V', phone: '9876543215', createdAt: '2026-01-20' },
];

const SEED_PARTICIPANTS = [
  { id: 'p1', name: 'Rahul Sharma', college: 'PSG College of Technology', department: 'Mechanical Engineering', year: '3rd', email: 'rahul@psg.edu', phone: '9871234560', eventName: 'Paper Presentation', paymentStatus: 'Paid', registrationDate: '2026-02-01' },
  { id: 'p2', name: 'Sneha Patel', college: 'Kongu Engineering College', department: 'Mechanical Engineering', year: '2nd', email: 'sneha@kongu.edu', phone: '9871234561', eventName: 'CAD Designing', paymentStatus: 'Paid', registrationDate: '2026-02-02' },
  { id: 'p3', name: 'Ajay Kumar', college: 'GCE Erode', department: 'Mechanical Engineering', year: '4th', email: 'ajay@gce.edu', phone: '9871234562', eventName: 'Tech Quiz', paymentStatus: 'Pending', registrationDate: '2026-02-03' },
  { id: 'p4', name: 'Kavitha R', college: 'Bannari Amman Institute', department: 'Mechanical Engineering', year: '3rd', email: 'kavitha@bait.edu', phone: '9871234563', eventName: 'Project Expo', paymentStatus: 'Paid', registrationDate: '2026-02-04' },
  { id: 'p5', name: 'Manoj K', college: 'Sri Krishna College', department: 'Mechanical Engineering', year: '2nd', email: 'manoj@skcet.edu', phone: '9871234564', eventName: 'Paper Presentation', paymentStatus: 'Paid', registrationDate: '2026-02-05' },
  { id: 'p6', name: 'Divya S', college: 'PSG College of Technology', department: 'Mechanical Engineering', year: '3rd', email: 'divya@psg.edu', phone: '9871234565', eventName: 'Connections', paymentStatus: 'Pending', registrationDate: '2026-02-06' },
  { id: 'p7', name: 'Surya V', college: 'Kongu Engineering College', department: 'Mechanical Engineering', year: '4th', email: 'surya@kongu.edu', phone: '9871234566', eventName: 'Workshop on 3D Printing', paymentStatus: 'Paid', registrationDate: '2026-02-07' },
  { id: 'p8', name: 'Anitha M', college: 'GCE Erode', department: 'Mechanical Engineering', year: '2nd', email: 'anitha@gce.edu', phone: '9871234567', eventName: 'Tech Quiz', paymentStatus: 'Paid', registrationDate: '2026-02-08' },
  { id: 'p9', name: 'Bala R', college: 'Bannari Amman Institute', department: 'Mechanical Engineering', year: '3rd', email: 'bala@bait.edu', phone: '9871234568', eventName: 'CAD Designing', paymentStatus: 'Paid', registrationDate: '2026-02-10' },
  { id: 'p10', name: 'Nithya K', college: 'Sri Krishna College', department: 'Mechanical Engineering', year: '4th', email: 'nithya@skcet.edu', phone: '9871234569', eventName: 'Project Expo', paymentStatus: 'Pending', registrationDate: '2026-02-12' },
  { id: 'p11', name: 'Ganesh P', college: 'SSM Institute', department: 'Mechanical Engineering', year: '2nd', email: 'ganesh@ssm.edu', phone: '9871234570', eventName: 'Paper Presentation', paymentStatus: 'Paid', registrationDate: '2026-02-14' },
  { id: 'p12', name: 'Meena L', college: 'Velalar College', department: 'Mechanical Engineering', year: '3rd', email: 'meena@velalar.edu', phone: '9871234571', eventName: 'Connections', paymentStatus: 'Paid', registrationDate: '2026-02-15' },
];
